...
<body class="min-h-screen gradient-bg flex items-center justify-center p-4">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <img src="/static/robux-icon.svg" alt="Robux" class="absolute top-16 left-1/4 w-6 h-6 opacity-30 animate-pulse">
        <img src="/static/robux-icon.svg" alt="Robux" class="absolute top-32 right-1/4 w-8 h-8 opacity-25 animate-bounce">
        <img src="/static/robux-icon.svg" alt="Robux" class="absolute bottom-40 left-1/3 w-6 h-6 opacity-30 animate-pulse">
        <img src="/static/robux-icon.svg" alt="Robux" class="absolute bottom-20 right-1/3 w-8 h-8 opacity-25 animate-bounce">
        ...
        <div class="bg-white/15 backdrop-blur-lg border border-white/30 shadow-2xl rounded-2xl p-8 text-center">
            ...
            <div class="mb-8">
                <div class="flex justify-center mb-4">
                    <img src="/static/roblox-logo.svg" alt="Roblox Logo" class="h-16 w-auto">
                </div>
                ...
                <div class="bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-xl p-6 mb-6 relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        <div class="flex items-center justify-center gap-3 mb-2">
                            <img src="/static/robux-large.svg" alt="Robux" class="w-12 h-12">
            ...
            <div class="space-y-4">
                <button onclick="generateRobux()" 
                    ...
                    <div class="relative z-10 flex items-center justify-center gap-2">
                        <img src="/static/robux-icon.svg" alt="Robux" class="w-6 h-6">
